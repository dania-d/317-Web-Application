...
router.post('/createPost', uploader.single("uploadImage"), (req, res, next) => {
    ...
    let fileAsThumnbnail = `thumbnail-${req.file.filename}`;
    let destinationOfThumbnail = req.file.destination + "/" + fileAsThumnbnail;
    ...
    try {
        ...
        if (!searchTerm) {
            ...
            if (results.length) {
                ...
                res.send({
                    message: "No results found. Here are the 8 most recent posts",
                    results: results,
                });
            }
        }
